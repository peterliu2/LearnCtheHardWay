...
extern int binsert(bstring s1, int pos, const_bstring s2,
				   unsigned char fill);
...
extern int bsetstr(bstring b0, int pos, const_bstring b1,
				   unsigned char fill);
...
extern int bisstemeqcaselessblk(const_bstring b0, const void *blk,
								int len);
...
extern struct bstrList *bsplit(const_bstring str,
							   unsigned char splitChar);
extern struct bstrList *bsplits(const_bstring str,
								const_bstring splitStr);
extern struct bstrList *bsplitstr(const_bstring str,
								  const_bstring splitStr);
extern bstring bjoin(const struct bstrList *bl, const_bstring sep);
extern bstring bjoinblk(const struct bstrList *bl, const void *s,
						int len);
...
extern int bsplitscb(const_bstring str, const_bstring splitStr, int pos,
					 int (*cb) (void *parm, int ofs, int len),
					 void *parm);
extern int bsplitstrcb(const_bstring str, const_bstring splitStr,
					   int pos, int (*cb) (void *parm, int ofs,
							   int len), void *parm);
...
extern int bvcformata(bstring b, int count, const char *fmt,
					  va_list arglist);
